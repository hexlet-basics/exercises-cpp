...
* PascalCase (или UpperCamelCase) — каждое слово в переменной пишется с заглавной буквы. Например: `MySuperVar`.
...
* константы — пишем в стиле PascalCase добавляя префикс `k`. Например: `const int kDaysInAWeek = 2`.
* классы — пишем в стиле PascalCase. Например: `MySuperClass`.
* функции — пишем также как и классы в стиле PascalCase. Например: `OpenFile()`.
